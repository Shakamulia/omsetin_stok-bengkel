...
class _SharePageState extends State<SharePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final storeName = storeSettings?['settingName'] ?? 'OMZETin Bengkel';
    final storeLogoPath = storeSettings?['settingImage'];
    final storeFooter =
        storeSettings?['settingFooter'] ?? 'Terima kasih telah berbelanja !';
    return Scaffold(
      ...
      body: Stack(
        children: [
                                    ...
                                    children: [
                                      ...
                                      Gap(5),
                                        ...
                                        child: ListView.builder(
                                          ...
                                          physics:
                                              const NeverScrollableScrollPhysics(),
                                          itemCount: widget.service?.length ?? 0,
                                          itemBuilder: (context, index) {
                                            final service = widget.service![index];
                                            return Padding(
                                              padding: const EdgeInsets.symmetric(
                                                  vertical: 8.0, horizontal: 8),
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      Text(
                                                        "${service['quantity']} x Rp. ${NumberFormat.currency(locale: 'id_ID', symbol: '', decimalDigits: 0).format(service['services_price'])}",
                                                        style: GoogleFonts.poppins(
                                                          fontSize: 14,
                                                          color: Colors.black,
                                                        ),
                                                      ...
                                                      Text(
                                                        "Rp. ${NumberFormat.currency(locale: 'id_ID', symbol: '', decimalDigits: 0).format(service['services_price'] * service['quantity'])}",
                                                        style: GoogleFonts.poppins(
                                                            fontSize: 14,
                                                            fontWeight:
                                                                FontWeight.w500,
          ...
          Positioned(
              bottom: 15, left: 15, right: 15, child: _buildShareButton()),
        ],
      ),
    );
  }
